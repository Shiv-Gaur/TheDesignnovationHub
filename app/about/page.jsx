...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <header className="bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16 gap-4">
            <Link
              href="/"
              className="flex items-center space-x-1.5 sm:space-x-2 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors duration-300 flex-shrink-0"
            >
            ...
            <div className="flex items-center space-x-1.5 sm:space-x-2">
              <img
                src="/tdh-logo.png"
                alt="TDH Logo"
                className="h-5 w-5 sm:h-6 sm:w-6 dark:invert flex-shrink-0"
              />
              <h1 className="text-sm sm:text-lg md:text-xl font-bold truncate">About The Designnovation Hub</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      {/* Hero Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-black dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4 lg:mb-6">
                The Designnovation Hub
              </h1>
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 dark:text-gray-300 mb-5 sm:mb-6 lg:mb-8">
                Empowering the next generation of innovators through design thinking and technology.
              </p>
              <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center p-3 sm:p-4 bg-white/50 dark:bg-gray-800/50 rounded-lg">
                    <stat.icon className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-blue-600 dark:text-blue-400 mx-auto mb-1 sm:mb-2" />
            ...
            <div className="relative rounded-lg shadow-2xl bg-gray-900 dark:bg-black border border-gray-800 overflow-hidden w-full">
              <div className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-gray-800/80 border-b border-gray-700 text-xs text-gray-300 font-mono">
              ...
              <div className="p-4 sm:p-6 min-h-[280px] sm:min-h-[320px] lg:min-h-[360px]">
                <TypingCode
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4 lg:mb-6">
                Founder's Message
              </h2>
              <div className="text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-300 space-y-3 sm:space-y-4">
                <p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 lg:gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-white dark:bg-gray-800 p-5 sm:p-6 rounded-lg shadow-lg text-center hover:shadow-xl transition-shadow duration-300"
              >
                <value.icon className="w-10 h-10 sm:w-12 sm:h-12 text-blue-600 dark:text-blue-400 mx-auto mb-3 sm:mb-4" />
              ...
              >
                <div className="p-4 sm:p-5 lg:p-6 flex items-center gap-3 sm:gap-4">
                  <img
                    ...
                    loading="lazy"
                    decoding="async"
                    className="h-14 w-14 sm:h-16 sm:w-16 rounded-full object-cover ring-2 ring-blue-600/10 dark:ring-blue-400/20 flex-shrink-0"
                  />
