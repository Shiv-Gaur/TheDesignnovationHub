      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-black dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative rounded-lg shadow-2xl bg-gray-900 dark:bg-black border border-gray-800 overflow-hidden w-full max-w-full lg:max-w-[560px]">
              ...
              <div className="p-4 sm:p-6 min-h-[280px] sm:min-h-[360px]">
                <TypingCode
