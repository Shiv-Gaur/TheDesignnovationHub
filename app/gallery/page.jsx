...
export default function GalleryPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white transition-colors duration-300">
      ...
      {/* Filters */}
      <section className="py-6 sm:py-8 bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start sm:items-center justify-between">
            <div className="flex items-center space-x-2">
              <Filter size={18} className="sm:w-5 sm:h-5 text-gray-600 dark:text-gray-400" />
            ...
            <div className="flex flex-wrap gap-2 w-full sm:w-auto">
              <select
                ...
                className="flex-1 sm:flex-none px-3 sm:px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
              >
          ...
          {filteredItems.length === 0 ? (
            <div className="text-center py-12 sm:py-16 lg:py-20">
              ...
              <button
                ...
                className="bg-blue-600 dark:bg-blue-500 text-white px-5 sm:px-6 py-2 rounded-md hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors duration-300 text-sm sm:text-base"
              >
                Clear Filters
              </button>
            </div>
                ...
                >
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-3 sm:top-4 left-3 sm:left-4">
                      <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-blue-600 dark:bg-blue-500 text-white text-xs sm:text-sm rounded-full">
                        {item.category}
                      </span>
                    </div>
                    <div className="absolute top-3 sm:top-4 right-3 sm:right-4">
                      <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-gray-900 dark:bg-gray-700 text-white text-xs sm:text-sm rounded-full">
                        {item.year}
                      </span>
                    </div>
                  </div>
                  <div className="p-4 sm:p-5 lg:p-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-3 sm:mb-4">
                      <div className="flex items-center space-x-1">
                    ...
                    <div className="flex items-center space-x-1 text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-3 sm:mb-4">
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {item.tags.map((tag, index) => (
                        <span
                          key={index}
                          className="px-2 py-0.5 sm:py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs rounded-full"
                        >
                          {tag}
                        </span>
                      ))}
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 lg:gap-8">
            <div className="text-center p-4 sm:p-6 bg-gray-50 dark:bg-gray-900/50 rounded-lg">
