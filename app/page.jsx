...
export default function TDHPortfolio() {
  ...
  const [selectedProjectTag, setSelectedProjectTag] = useState("All")
        {/* Projects Section */}
        <section id="projects" className="py-12 sm:py-16 lg:py-20 bg-white dark:bg-black transition-colors duration-500">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            </div>DarkMode, setIsDarkMode] = useState(false)
      ...
      <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white">
        ...
        <footer className="bg-gray-900 dark:bg-black text-white py-12 transition-colors duration-500">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="md:col-span-2 animate-on-scroll">
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  />
                  <h3 className="text-base sm:text-lg font-bold hover:scale-105 transition-transform duration-300">The Designnovation Hub</h3>
                </div>
                ...
                <div className="mt-6">
                  <h4 className="text-sm font-semibold text-gray-400 mb-3">Proudly Part Of</h4>
                  <div className="flex items-center space-x-4">
                    ...
                    />
                    <div className="hidden flex-col items-center justify-center h-12 px-6 bg-gray-800 rounded border border-gray-700">
            ...
            <div className="border-t border-gray-800 mt-8 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center animate-on-scroll gap-2 sm:gap-0">
              <p className="text-gray-300 text-xs sm:text-sm text-center md:text-left">© 2025 TDH - The Designnovation Hub. All rights reserved.</p>
              <p className="text-gray-300 text-xs sm:text-sm text-center md:text-right">Designed by TDH Web Team</p>
            </div>
          </div>
        </footer>
      </div>
