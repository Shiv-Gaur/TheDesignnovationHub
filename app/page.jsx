  ...
  return (
    <div className="min-h-screen transition-colors duration-300">
      <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white">
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-10 sm:mb-12 animate-on-scroll px-2">
              {projectTags.map((tag) => (
                <button
                  ...
                  className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium transition-all duration-300 hover:scale-110 ${
                  ...
                  <div className="p-4 sm:p-5 lg:p-6">
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-4">
                      {project.tags.map((tag) => (
                        <span
                          key={tag}
                          className="px-2 py-0.5 sm:py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 text-xs rounded-full hover:scale-110 transition-transform duration-300"
                        >
                          {tag}
                        </span>
                      ))}
              ...
              {events.map((event, index) => (
                ...
                >
                  ...
                  <div className="p-4 sm:p-5 lg:p-6">
                    ...
                    <span
                      aria-disabled="true"
                      className="w-full block text-center bg-gray-400 dark:bg-gray-700 text-gray-100 py-2 rounded-md font-medium cursor-not-allowed select-none text-sm"
                    >
                      Registration Closed
                    </span>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
              ...
              <div className="animate-on-scroll">
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4 sm:space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-blue-600 dark:bg-blue-500 text-white py-2.5 sm:py-3 rounded-md font-medium hover:bg-blue-700 dark:hover:bg-blue-600 transition-all duration-300 hover:scale-105 hover:shadow-lg text-sm sm:text-base"
                  >
                    Send Message
                  </button>
                </form>
              ...
              <div className="space-y-6 sm:space-y-8 animate-on-scroll">
                <div className="hover:scale-105 transition-transform duration-300">
                  ...
                  <form onSubmit={handleMembershipSubmit} className="space-y-3 sm:space-y-4">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 sm:p-6 rounded-lg hover:scale-105 transition-transform duration-300">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center space-x-2 bg-green-600 dark:bg-green-500 text-white px-4 sm:px-6 py-2 rounded-md font-medium hover:bg-green-700 dark:hover:bg-green-600 transition-all duration-300 hover:scale-105 hover:shadow-lg text-sm"
                  >
                    <MessageCircle size={18} className="sm:w-5 sm:h-5" />
        ...
        {/* Footer */}
        <footer className="bg-gray-900 dark:bg-black text-white py-10 sm:py-12 transition-colors duration-500">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              ...
              <div className="sm:col-span-2 animate-on-scroll">
                <div className="flex items-center space-x-2 mb-3 sm:mb-4">
                  ...
                  />
                  <h3 className="text-base sm:text-lg font-bold hover:scale-105 transition-transform duration-300">
                ...
                <div className="mt-4 sm:mt-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    />
                    <div className="hidden flex-col items-center justify-center h-10 sm:h-12 px-4 sm:px-6 bg-gray-800 rounded border border-gray-700">
                      <span className="text-xs text-gray-400">GEU Logo</span>
                  ...
                  {["Home", "Projects", "Events", "Team", "Contact"].map((item) => (
                    <li key={item}>
                      <button
                        ...
                        className="text-gray-300 hover:text-white transition-all duration-300 hover:scale-105 text-left"
                      >
                        {item}
                      </button>
                    </li>
              ...
              <div className="animate-on-scroll">
                ...
                <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base">
                  <li className="flex items-start space-x-2">
                    ...
                    <span className="text-gray-300 break-all">{siteData.contact.email}</span>
                  </li>
                  <li className="flex items-start space-x-2">
